...
Played as 4-note groupings:
(e8 e5 B8 B5) (B8 B5 G7 G5) (G7 G5 D7 D5) (D7 D5 A7 A5)`,
    coaching:
...
E|-----------------------------------------|`,
  ...
  },
  {
    ...
    tab: `e|------------------------------------------------|
B|--8b(10)------8--8b(10)r8----5-----5------------|
G|---------7----------------7----7-----7-5--------|
D|--------------------------------------------7---|
A|------------------------------------------------|
E|------------------------------------------------|

b(10)r8 = bend up a whole step, release to pitch of fret 8.`,
    coaching:
  ...
  },
  {
    ...
    tab: `Bar 1 (CALL — ends on tension):
e|--------------------------|
B|--5--8b(10)---------------|
G|-------------7--5---------|
D|-----------------7--------|
...
E|------------------5~~~----|`,
  ...
  },
  {
    ...
    tab: `Bar 1 (question, pushes into bar 2):
e|-----------------5--------|
B|--5--8--5--8---------8----|
G|-----------------7--------|

Bar 2 (answer, displaced):
e|--------------------------|
G|--5--7-----5--------------|
D|-------7----------7-------|
A|-------------------7------|
E|-----------------------5~~|`,
  ...
  },
  {
    ...
    tab: `e|---------------------5--7--8--|
B|---------------5--7--8--------|
G|---------4--5--7--------------|   ← fret 4 outside box 1 (F♯ passing)
D|---5--7--8--------------------|   ← fret 8 outside box 1 nominal
A|-5-7-8------------------------|   ← fret 8 outside box 1 nominal
E|-5-7-8------------------------|`,
    coaching:
...
G|------------------5--7-----------|
D|-----------5--7------------------|
A|-5--7--6--7----------------------|   ← A-string: A(5)–E(7)–E♭(6)–E(7)
E|-5-------------------------------|`,
    coaching:
